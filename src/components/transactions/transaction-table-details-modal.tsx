...
import { models } from '@grupo21/shared-react'
...
export interface TransactionDetailsHandle {
  open: (tx: typeof models.Transaction) => void;
  close: () => void;
}

type Props = {
  onEdit?: (tx: typeof models.Transaction) => void;
  onDelete?: (tx: typeof models.Transaction) => void | Promise<void>;
  onClose?: () => void;
};
...
const TransactionDetailsModal = forwardRef<TransactionDetailsHandle, Props>(
  function TransactionDetailsModal({ onEdit, onDelete }, ref) {
    ...
    const [tx, setTx] = useState<typeof Transaction | null>(null);
            ...
            <div className="rounded-xl bg-slate-50 p-4 border border-gray-400">
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <div
                    className={`font-medium ${isIncome ? "text-emerald-600" : "text-rose-600"
                      }`}
                  >
