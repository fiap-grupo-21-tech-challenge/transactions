...
import { transactions, models } from '@grupo21/shared-react'
...
const TYPE_OPTIONS: { value: typeof models.TransactionType; label: string }[] = [
  { value: "deposito", label: "Depósito" },
  { value: "saque", label: "Saque" },
  { value: "transferencia", label: "Transferência" },
];

const CATEGORY_OPTIONS: { value: typeof models.TransactionCategory; label: string }[] = [
...
export default function TransactionForm({ initial, onSaved, onCancel }: Props) {
  ...
  const [type, setType] = useState<typeof TransactionType | "">("");
  const [category, setCategory] = useState<typeof TransactionCategory | "">("");
  ...
  async function onSubmit(e: FormEvent) {
    ...
    setSubmitting(true);
    try {
      const typeSafe = type as typeof TransactionType;
      const categorySafe = category as typeof TransactionCategory;
    ...
    <form onSubmit={onSubmit} className="space-y-5">
      ...
      <div className="grid gap-4">
        <FormField
          ...
          value={type}
          onChange={(e) => setType(e.target.value as typeof TransactionType)}
          options={[
        ...
        <FormField
          ...
          value={category}
          onChange={(e) =>
            setCategory(e.target.value as typeof TransactionCategory | "")
          }
          options={[
